...
public class GenericCoapResponseHandler implements CoapHandler
{
	...
	/**
	 * Constructor.
	 * @param IDataMessageListener listener
	 */
	...
	/**
	 *Call back function when thew respionse is loaded
	 *@param the response loaded
	 */
	@Override
...
//			_Logger.finest("Processing CoAP response. Code: " + response.getCode());
	...
	/**
	 * Callback method when an error happens
	 */
	@Override
	public void onError()
	{
	...
	/**
	 * Thje setter of the data listener
